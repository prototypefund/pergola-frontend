    ...
    <#elseif section = "info" >
        <#if realm.password && social.providers??>
            <div id="kc-social-providers">
                <div>${msg("loginSocialProvider")}</div>
                <ul class="mdc-list">
                    <#list social.providers as p>
                        <li class="mdc-list-item"><span class="mdc-list-item__graphic material-icons" aria-hidden="true">login</span><a href="${p.loginUrl}" id="zocial-${p.alias}" class="zocial ${p.providerId}"> <span class="mdc-list-item__text">${p.displayName}</span></a></li>
                    </#list>
                </ul>
            </div>
        </#if>
